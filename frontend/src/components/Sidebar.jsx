...
import IIITA_LOGO from "./images/IIITA_LOGO.png"
...
<img src={icon} className="h-5 w-5 mr-3" alt="" />{/* <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns={icon}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg> */}
